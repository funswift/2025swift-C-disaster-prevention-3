...
export const PopUpComponent = memo((props: Props) => {
  ...
  return (
    <>
      <div
       style={{ display: viewFlag ? 'flex' : 'none' }}
        className="fixed z-50 flex-col items-center justify-center overflow-hidden bg-gray-500/50 top-0 left-0 h-screen w-screen"
